import{f as r,m as i,c as _,j as V,d as h,w as B,u as o,o as c,g as p,v as m,b as u,i as y,a as A,t as b,h as k}from"./index-CnDFdbL1.js";import{_ as w}from"./Content-CvjWIKzT.js";const N={key:0},C={__name:"GroupArrayByProperty",setup(j){const f=r("[Algorithm] 群組化物件陣列 (Group Array of Objects by Property)"),d=r("寫一個函數根據指定的屬性將物件陣列分組"),g=r('console.log(groupBy(items, "type"))'),n=r(""),s=r(i.slice(1));s.value.forEach(t=>t.url="");const a=r(JSON.stringify(s.value,null,2)),v=_(()=>s.value.reduce((t,e)=>(t[e.category]||(t[n.value]=[]),t[n.value].push(e),t),{}));V(a,t=>{try{i.value=JSON.parse(t)}catch(e){console.log(e)}});const x=r(`
  \`\`\`javascript
