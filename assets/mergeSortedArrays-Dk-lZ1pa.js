import{e as l,f as x,b as v,w as B,u as t,o as p,g as m,v as c,a as u,i as g,c as _,t as j,h as V}from"./index-CvHUwKFP.js";import{_ as w}from"./Content-BcFxYVTo.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const k={key:0},N={__name:"mergeSortedArrays",setup(S){const d=l("[Algorithm] 合併兩個已排序的陣列 (merge Sorted Arrays)"),f=l("寫一個函數來合併兩個已經排序的陣列，並保持合併後的陣列有序"),h=l("console.log(mergeSortedArrays([1, 3, 5], [2, 4, 6])); // [1, 2, 3, 4, 5, 6]"),r=l(""),i=l(""),A=x(()=>{let s=r.value.split(""),e=i.value.split(""),n=[],o=0,a=0;for(;o<s.length&&a<e.length;)s[o]<e[a]?(n.push(s[o]),o++):(n.push(e[a]),a++);return n.concat(s.slice(o)).concat(e.slice(a))}),y=l(`
  \`\`\`javascript
