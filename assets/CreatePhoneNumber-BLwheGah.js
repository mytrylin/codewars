import{r as t,c as d,d as f,u as e,o as a,w as v,e as _,v as h,b as w,i as x,a as b,t as j,f as $}from"./index-BLPjndYo.js";import{_ as k}from"./Content-Cye-U4OO.js";const C={key:0},V={__name:"CreatePhoneNumber",setup(N){const i=t("[Codewars] Create Phone Number"),l=t("編寫一個接受 10 個整數（0 到 9 之間）的陣列的函數，該函數以電話號碼的形式傳回這些數字的字串"),r=t('reatePhoneNumber([1, 2, 3, 4, 5, 6, 7, 8, 9, 0]) // => returns "(123) 456-7890"'),c=t("https://www.codewars.com/kata/525f50e3b73515a6db000b83"),o=t(""),u=d(()=>{let n=o.value.split("");return n.length?`(${n.slice(0,4).join("")}) -  ${n.slice(4,7).join("")} - ${n.slice(7,10).join("")}`:""}),p=t(`
  \`\`\`javascript
    function solution(A) { 
