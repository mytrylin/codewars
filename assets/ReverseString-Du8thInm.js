import{r as t,c as u,d as m,w as d,u as e,o as i,e as f,v,b as _,i as x,a as g,t as h,f as k}from"./index-BTZgGJZT.js";import{_ as B}from"./Content-DNimQkls.js";const S={key:0},A={__name:"ReverseString",setup(V){const r=t("[Algorithm] 反轉字串 (Reverse String)"),a=t("寫一個函數來反轉給定的字串"),l=t('console.log(reverseString("hello")); // "olleh"'),o=t(""),s=u(()=>o.value.split("").reverse().join("")),c=t(`
  \`\`\`javascript
    function solution(A) { 
