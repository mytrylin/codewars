import{f as o,c as m,d as p,w as f,u as t,o as a,g as d,v as _,b as h,i as x,a as v,t as y,h as A}from"./index-BZ8PaDDA.js";import{_ as g}from"./Content-B6GxBFZO.js";import"./_plugin-vue_export-helper-DlAUqK2U.js";const S={key:0},C={__name:"ShuffleArraySort",setup(k){const r=o("[Algorithm] 隨機陣列排序 (Shuffle Array Sort)"),n=o("隨機打亂陣列中的元素順序"),i=o("console.log(shuffleArray([1, 2, 3, 4, 5])); // 隨機排序的陣列，例如 [3, 1, 5, 2, 4]"),e=o(""),l=m(()=>e.value.split("").sort(()=>Math.random()-.5)),c=o(`
  \`\`\`javascript
    function solution(A) { 
